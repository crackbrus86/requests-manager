...
if(current_user_can("edit_others_pages")){
    ...
    $foreign_pass_issued_by = strip_tags(stripcslashes(trim($_POST["foreignPassIssuedBy"])));
    ...
    photo_international_pass_id = %d, accreditation_photo_id = %d, n_pass = %s, foreign_pass_issued_by = %s WHERE id = %d", $region, $latSurname, $latFirstName, $passSeria,
    $passNo, $passExpire, $iin, $phone, $email, $pnpId, $pipId, $apId, $n_pass, $foreign_pass_issued_by, $id);
