<?php
    ...
    photo_international_pass_id, accreditation_photo_id, n_pass, foreign_pass_issued_by FROM $tb_coaches WHERE last_name = '$data[lastName]' AND first_name = '$data[firstName]'
    ...
    PassportPhotoId AS photoId, ExpirationDate AS expireDate, IssuedBy AS issuedBy FROM $tb_for_passports WHERE UserId = %d", $coach->id);
