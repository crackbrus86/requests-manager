    ...
    <form>
        ...
        <div class="anotherData" style="display: none">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="photoOfNatPassId" id="photoOfNatPassId" />
            </div>
            <div class="form-group">
                ...
                <input type="hidden" name="photoOfForPassId" id="photoOfForPassId" />
            </div>
            <div class="form-group">
                ...
                <input type="hidden" name="accreditationPhotoId" id="accreditationPhotoId" />
            </div>
            <div class="form-group">
