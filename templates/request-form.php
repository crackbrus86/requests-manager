    ...
    <form>
        ...
        <div class="anotherData" style="display: none">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control required" id="firstNameLikeInPass" placeholder="First Name" maxlength="30" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control required" id="phone" placeholder="+38 (999) 999-99-99" maxlength="20" />
            </div>
            <div class="form-group">
            ...
            <button type="button" class="btn btn-primary" id="submitRequest">Надіслати</button>
        </div>
    </form>
</div>

<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="uploadPhotoModal">
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="showPhotoModal" id="showPhotoModal">
