            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="squat" id="squat" maxlength="6" value="00.00">
                    </div>
                    <div class="col-md-3">
                        <label for="benchPress">Жим лежачи</label>
                        <input type="text" name="benchPress" id="benchPress" maxlength="6" value="00.00">
                    </div>
                    <div class="col-md-3">
                        <label for="deadLift">Станова тяга</label>
                        <input type="text" name="deadLift" id="deadLift" maxlength="6" value="00.00">
                    </div>
                    <div class="col-md-3">
